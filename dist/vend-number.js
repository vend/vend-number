...
var VendNumber = {
   ...
   */
  VendNumber: function VendNumber(value) {
    /*
   ...
   */
  round: function round(value, decimalPoints) {
    // Convert to VendNumber if not already.
    value = value instanceof _bignumberJs2['default'] ? value : new VendNumber.VendNumber(value);
   ...
   */
  _executeOperation: function _executeOperation(operation, values) {
    var returnValue, _displayValueError, _ifValid, operationAnswer;
